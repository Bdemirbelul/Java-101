...
public class GelismisHesapMakinesi {
    ...
    static void plus() {
        ...
        while (true) {
            System.out.print(i++ + ". sayi (bitirmek icin 0): ");
            number = scan.nextInt();
            if (number == 0) {
                break;
            }
    ...
    static void times() {
        ...
        while (true) {
            System.out.print(i++ + ". sayi (bitirmek icin 1): ");
            number = scan.nextInt();
    ...
    static void divided() {
        ...
        for (int i = 1; i <= counter; i++) {
            ...
            if (i != 1 && number == 0) {
                System.out.println("Bolen 0 olamaz, bu adim atlandi.");
                continue;
            }
    ...
    static void mod() {
        ...
        if (number2 == 0) {
            System.out.println("Mod islemi icin ikinci sayi 0 olamaz.");
            return;
        }
    ...
    static void rectangle() {
        ...
        System.out.println("Dikdortgen Alani : " + area);
        System.out.println("Dikdortgen Cevresi : " + perimeter);
    }
